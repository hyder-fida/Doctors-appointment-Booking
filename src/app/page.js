...
export default function TherapistProfile() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      {/* Left Section */}
      <div className="w-full md:w-1/3 bg-blue-500 text-white p-6 flex flex-col items-center justify-center">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-sm text-center text-black">
          ...
          <div className="mt-6">
          <Link href="/sessions">
            <button className="bg-blue-500 text-white font-bold py-2 px-6 rounded-full w-full">
              Book session
            </button>
            </Link>
          </div>
